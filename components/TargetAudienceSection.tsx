...
export const TargetAudienceSection: React.FC<TargetAudienceSectionProps> = ({ onContactClick }) => {
    return (
        <section id="target-audience" className="bg-white dark:bg-[#0A0A2A] transition-colors duration-300 relative overflow-hidden">
             {/* Background Elements */}
            ...
            <div className="max-w-7xl mx-auto px-6 py-20 lg:py-24 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <h2 className="text-3xl md:text-4xl font-extrabold text-[#101663] dark:text-white mb-6 leading-tight font-display">
                    ...
                    <div className="p-8 bg-gradient-to-r from-[#101663] to-[#1a1a60] dark:from-[#0d0d35] dark:to-[#161642] rounded-3xl shadow-xl max-w-md">
                        <div className="flex flex-col items-center text-center space-y-4">
                            <p className="text-white/90 text-sm font-medium">Sua rede precisa de força operacional?</p>
                            <button 
                                onClick={onContactClick}
                                className="w-full bg-primary hover:bg-orange-600 text-white font-bold py-4 px-6 rounded-xl shadow-lg shadow-orange-500/30 transition-all transform active:scale-95 flex items-center justify-center space-x-2"
                            >
                ...
                <div className="space-y-4">
                    <div className="bg-white dark:bg-[#161642] p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center space-x-4 hover:shadow-md transition-shadow">
                        <div className="w-14 h-14 rounded-full bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center flex-shrink-0">
                            <Store className="w-7 h-7 text-[#101663] dark:text-blue-300" />
                        </div>
                        <div>
                            <h3 className="font-bold text-[#101663] dark:text-white text-lg">Redes e Franquias</h3>
                    ...
                    <div className="bg-white dark:bg-[#161642] p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center space-x-4 hover:shadow-md transition-shadow transform lg:translate-x-4">
                        ...
                        <div>
                            <h3 className="font-bold text-[#101663] dark:text-white text-lg">Múltiplas Unidades</h3>
                    ...
                    <div className="bg-white dark:bg-[#161642] p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center space-x-4 hover:shadow-md transition-shadow">
                        ...
                        <div>
                            <h3 className="font-bold text-[#101663] dark:text-white text-lg">Cooperativas e Varejo</h3>
